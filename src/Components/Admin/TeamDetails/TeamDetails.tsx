...
const TeamDetails = () => {
    ...
    const [newPrimaryColor, setNewPrimaryColor] = useState(organization?.bryxOrg.primaryColor);
    const [newSecondaryColor, setNewSecondaryColor] = useState(organization?.bryxOrg.secondaryColor);
    ...
    const handleCloseDialog = () => {
        ...
        setNewPrimaryColor(organization?.bryxOrg.primaryColor);
        setNewSecondaryColor(organization?.bryxOrg.secondaryColor);
        ...
        <>
            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <TeamLogoSelector currentLogoUrl={organization?.bryxOrg.logoUrl} setNewLogo={setNewLogo} />
                </div>
            </Modal>
        </>
    );
