...
const packages: Subscription[] = [
    { id: 'starter', name: 'Starter', monthlyPrice: 'Free', features: ['Single user account', 'Create up to 3 Templates', 'Save 10 Estimates'] },
    { id: 'pro', name: 'Pro', monthlyPrice: '$15/mo', features: ['Single user account', 'Create up to 5 Templates', 'Unlimited Estimates'] },
    { id: 'team', name: 'Team', monthlyPrice: '$50/mo', features: ['Up to 10 team members', 'Create Unlimited Templates', 'Unlimited Estimates'] }
];

const SubscriptionDialog: React.FC<Props> = ({ open, onClose }) => {
